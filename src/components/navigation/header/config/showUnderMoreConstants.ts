...
export const sell: ShowUnderMoreBreakpoint = `(max-width: ${breakpoints.md.px}px)`;
...
export const showMoreDrawer = `(min-width: ${minWidthMore + 1}px) and (max-width: ${maxWidthMore}px)`;
export const showMoreDrawerInsideSearchDrawer: ShowUnderMoreBreakpoint = `(max-width: ${minWidthMore}px)`;
