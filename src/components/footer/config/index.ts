      ...
      items: [
        {
          ...
          link: {
            de: 'https://swissmarketplace.group/de/kategorie/mitteilungen-an-die-presse/automobilindustrie/',
            en: 'https://swissmarketplace.group/category/media-releases/automotive/',
            fr: 'https://swissmarketplace.group/fr/categorie/communiques-de-presse-fr/automobile/',
            it: 'https://swissmarketplace.group/category/media-releases/automotive/',
          },
          target: '_blank',
        },
      ],
